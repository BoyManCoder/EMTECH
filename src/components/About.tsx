function About() {
    ...
    return (
        <>
            <section id="about" className="w-screen h-full font-robotoSlab text-5xl mt-16 overflow-hidden pb-20 px-4 sm:px-8 py-8">
                ...
                <div className="w-full h-full flex flex-col sm:flex-row justify-evenly items-center sm:items-start sm:space-y-0 space-y-6 sm:space-x-6">
                    {cards.map((card, index) => (
                        <div
                            key={index}
                            className="h-auto sm:h-96 w-4/5 p-5 sm:w-1/3 bg-soft rounded-xl overflow-hidden flex flex-col shadow-lg"
                        >
